...
**A decision record for М12_DomainVMS** (written when this material lived in the module above it). Companion to [`kubernetes-vs-nomad.md`](../М11_ClusterVMS/kubernetes-vs-nomad.md), [`rauc-alternatives.md`](../М9_EdgeVMS/rauc-alternatives.md) and [`apphost-and-process-model.md`](../М9_EdgeVMS/apphost-and-process-model.md), written in answer to "Consul or OpenBao?" — which turns out to be the wrong question, in a useful way.
