...
Built on М9's nodevms (imported, not copied): identity from a Nomad
...
# nodevms is the М9 project, two directories up. In the container image it
...
for cand in (os.environ.get("NODEVMS_PATH", ""),
             ...
             os.path.join(os.path.dirname(os.path.dirname(_here)), "М9_EdgeVMS", "nodevms")):
