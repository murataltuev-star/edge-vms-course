"""Configuration is read from the environment (М8 Lesson 13). Credentials
never live in the image; on the appliance the EnvironmentFile is on the data
partition (М9 Lesson 19)."""
...
class Settings:
    ...
    # Lesson 22: segment length is a product decision. It bounds what a hard
    # kill loses (Lesson 23, Step 4) and sets how many index rows you write.
    ...
    # Lesson 21, Step 4: one task per concern.
    ...
    # Lesson 23, Step 3: retention and the disk-full policy.
